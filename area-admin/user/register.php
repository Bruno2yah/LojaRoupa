...
require_once '../autenticacaoAdm.php';
  ...
  if(!empty($_POST)){
    ...
    $nome_User =  $userDao['nomeUsuario'];
    $sobrenome_User = $userDao['sobrenomeUsuario'];
    $cpf_User = $userDao['cpfUsuario'];
    $nasc_User= $userDao['dataNascimentoUsuario'];
    $email_User = $userDao['emailUsuario'];
    $password_User = $userDao['senhaUsuario'];
    $imagem_User = $userDao['imagemUsuario'];
    }else{
      $nome_User = '';
      $sobrenome_User = '';
      $cpf_User = '';
