        ...
        <div class=" row">
          <table class="table table-hover">
            <thead>
              ...
              <tr>
                <td><?=$user[0]?></td>
                <td><?= date('d/m/Y', strtotime($user[3]));  ?></td>
                <td><?=$user[1]?> <?=$user[2]?></td>
                <td><?=$user[5]?></td>
                <td><?=$user[4]?></td>
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$user[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
