        ...
        <div class="d-flex justify-content-center align-items-center bg-white boxForm rounded-5 ">
          <form class="w-100 p-3 p-md-4" method="post" action="#">
            <div class="d-flex flex-column gap-3">
              ...
              <?php require_once '../user/processLogin.php';?>
              <div class=" flex-column d-flex gap-5">
                ...
                <a href="./cadastro.php"><button class="w-100 btn btn-lg" style="background-color: #4400c2; color: white" type="button">É novo aqui? cadastre-se</button></a>
              </div>
