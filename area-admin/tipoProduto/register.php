...
require_once("../../componentes/modal.php");
  ...
  if(!empty($_POST)){
    $id_TipoProduto = $tipoProduto['idTipoProduto'];
    $tipo_TipoProduto =  $tipoProduto['tipo'];
    }else{
      $id_TipoProduto = '';
      $tipo_TipoProduto = '';
    }
        ...
        <div class="card">
          <form method="post" action="process.php" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="card-header">
              ...
              <input type="hidden" name="idTipoProduto" id="idTipoProduto" placeholder="id" value="<?=$id_TipoProduto?>">
              <input type="hidden" value="<?=$id_TipoProduto?'ATUALIZAR':'SALVAR'?>" name="acao" >
            </div>
              ...
              <div class=" col-md-10">
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="tipo" maxlength="30" id="tipo" value="<?=$tipo_TipoProduto?>" required>
