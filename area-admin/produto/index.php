            ...
            <thead>
              ...
              <tr>
                <td class="justify-content-center d-flex align-items-center">
                  ...
                  <img id="preview" src="../../img/product/produto/<?=$produto[2]?>" alt="..."
                      class="w-100"  style="height:47px; width: 30px; object-fit: cover;" >
                  </div>
                </td>
                <td><?=$produto[1]?></td>
                <td><?=$produto[3]?></td>
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$produto[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
