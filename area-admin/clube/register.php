...
require_once '../autenticacaoAdm.php';
  ...
  $liga = LigaDao::selectAll();

  if(!empty($_POST)){
    $id_clube = $clubeDao['idClube'];
    $nome_clube =  $clubeDao['nome'];
    $apelido_clube =  $clubeDao['apelido'];
    $foto_clube = $clubeDao['foto'];
    $idLiga_clube = $clubeDao['idLiga'];
    }else{
      $id_clube = '';
      $nome_clube = '';
      $apelido_clube = '';
        ...
        <div class="card">
          <form method="post" action="process.php" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="card-header">
              ...
              <input type="hidden" name="idClube" id="idClube" placeholder="id" value="<?=$id_clube?>">
              <input type="hidden" name="foto" id="foto" placeholder="foto" value="<?=$foto_clube?>">
              <input type="hidden" value="<?=$id_clube?'ATUALIZAR':'SALVAR'?>" name="acao" >
            </div>
            <div class="card-body row justify-content-center align-items-center">
              <div class="col-md-2   text-center">
                <div class="bg-white rounded">
                <img id="preview" src="../../img/product/clube/<?=$foto_clube!="" ? $foto_clube : 'semFoto.png';?>" alt="..."
              ...
              <div class=" col-md-10">
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="nome" maxlength="30" id="nome" value="<?=$nome_clube?>" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="apelido" maxlength="30" id="apelido" value="<?=$apelido_clube?>" required>
                    <div class="invalid-feedback">
                     Preencha o campo
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                     <select name = idLiga class="form-select" required>
                      <option value = "" disabled selected>Selecione a liga</option>
                      <?php foreach($liga as $liga) {?>
                        <option value = <?=$liga[0]?>><?=$liga[1]?></option>
                      <?php }?>
                    </select>
                    <div class="invalid-feedback">
                     Preencha o campo
