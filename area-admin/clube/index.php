          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-2">apelido</th>
                <th class="col-md-3">Liga</th>
              ...
              <tr>
                ...
                <img id="preview" src="../../img/product/clube/<?=$clube[3]?>" alt="..."
                    class="w-100"  style="height:30px; width: 30px; object-fit: cover; overflow: hidden; " >
                </div></td>
                <td><?=$clube[1]?></td>
                <td><?=$clube[2]?></td>
                <td><?=$clube[5]?></td>
                <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$clube[0]?>">
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$clube[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
    ...
    <div class=" modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-danger text-white">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir País</h1>
