...
require_once("../../componentes/modal.php");
  ...
  if(!empty($_POST)){
    $id_TamanhoProduto = $tamanhoProduto['idTamanhoProduto'];
    $tamanho_TamanhoProduto =  $tamanhoProduto['tamanho'];
    }else{
      $id_TamanhoProduto = '';
      $tamanho_TamanhoProduto = '';
    }
?>
        ...
        <div class="card">
          <form method="post" action="process.php" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="card-header">
              ...
              <input type="hidden" name="idTamanhoProduto" id="idTamanhoProduto" placeholder="id" value="<?=$id_TamanhoProduto?>">
              <input type="hidden" value="<?=$id_TamanhoProduto?'ATUALIZAR':'SALVAR'?>" name="acao" >
            </div>
              ...
              <div class=" col-md-10">
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="tamanho" maxlength="3" id="tamanho" value="<?=$tamanho_TamanhoProduto?>" required>
