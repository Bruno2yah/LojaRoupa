...
require_once '../autenticacaoAdm.php';
  ...
  $tamanhoProduto = TamanhoProdutoDao::selectAll();
?>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-3">Tamanho </th>
                <th class="text-center col-md-1">Alterar</th>
                <th class="text-center col-md-1">Excluir</th>
              </tr>
              <?php foreach($tamanhoProduto as $tamanhoProduto) { ?>
              <tr>
                <td><?=$tamanhoProduto[0]?></td>
                <td><?=$tamanhoProduto[1]?></td>
                <td class="text-center">
                  <form action="process.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$tamanhoProduto[0]?>">
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$tamanhoProduto[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
