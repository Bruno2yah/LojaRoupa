            ...
            <thead>
              ...
              <tr>
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$admin[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
