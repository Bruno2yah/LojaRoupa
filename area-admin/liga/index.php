          ...
          <table class="table table-hover">
            <thead>
              ...
              <tr>
                ...
                <img id="preview" src="../../img/product/liga/<?=$liga[3]?>" alt="..."
                    class="w-100"  style="height:30px; width: 30px; object-fit: cover;" >
                </div></td>
                <td><?=$liga[1]?></td>
                <td><?=$liga[2]?></td>
                <td><?=$liga[5]?></td>
                <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$liga[0]?>">
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$liga[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
