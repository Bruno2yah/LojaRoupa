              ...
              <tr>
                ...
                <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$marca[0]?>">
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$marca[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
