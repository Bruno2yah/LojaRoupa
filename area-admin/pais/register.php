...
require_once("../../componentes/modal.php");
  ...
  if(!empty($_POST)){
    $id_Pais = $paisDao['idPais'];
    $nome_Pais =  $paisDao['nome'];
    $foto_Pais = $paisDao['foto'];
    }else{
      $id_Pais = '';
      $nome_Pais = '';
      $foto_Pais = '';
        ...
        <div class="card">
          <form method="post" action="process.php" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="card-header">
              ...
              <input type="hidden" name="idPais" id="idPais" placeholder="id" value="<?=$id_Pais?>">
              <input type="hidden" name="foto" id="foto" placeholder="foto" value="<?=$foto_Pais?>">
              <input type="hidden" value="<?=$id_Pais?'ATUALIZAR':'SALVAR'?>" name="acao" >
            </div>
            <div class="card-body row justify-content-center align-items-center">
              <div class="col-md-2   text-center">
                <div class="bg-white rounded">
                <img id="preview" src="../../img/product/pais/<?=$foto_Pais!="" ? $foto_Pais : 'semFoto.png';?>" alt="..."
              ...
              <div class=" col-md-10">
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="nome" maxlength="30" id="nome" value="<?=$nome_Pais?>" required>
