...
<head>
  ...
  <title>FilmeOn - fornecedor</title>
          ...
          <table class="table table-hover">
            <thead>
              ...
              <tr>
                <td><?=$fornecedor[0]?></td>
                <td><?=$fornecedor[1]?></td>
                <td><?=$fornecedor[2]?> <?=$fornecedor[2]?></td>
                <td><?=$fornecedor[3]?></td>
                <td><?=$fornecedor[4]?></td>
                <td class="text-center">
                  <form action="process.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$fornecedor[0]?>">
                ...
                <td class="text-center ">
                  ...
                  <button type="submit" onclick="modalRemover(<?=$fornecedor[0]?>,'idDeletar')" class="dropdown-item" ><i class="fas fa-trash-alt fa-lg text-danger"></i></button>
                  </a>
                </td>
              <tr>
                <?php } ?>
